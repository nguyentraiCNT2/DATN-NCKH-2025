...
const Header = () => {
    ...
    const isActive = (href) => {
        ...
        return hrefPath === currentPath ? 'nav-link active' : 'nav-link';
    };
    return (
        <div>
            <header class="main-header">
                ...
                <div class="navbar">
                    ...
                    <a href="/follow-post" className={isActive('/follow-post')}>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
                            <path
                    ...
                    <a href="/list-group" className={isActive('/list-group')}>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
                            <path
                    ...
                    <a href="/message#last-chat" className={isActive('/message')}>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
                            <path
                ...
                <div class="header-profile">
                    <a href="/setting" className={isActive('/setting')}>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
                            <path
                                d="M440-120v-240h80v80h320v80H520v80h-80Zm-320-80v-80h240v80H120Zm160-160v-80H120v-80h160v-80h80v240h-80Zm160-80v-80h400v80H440Zm160-160v-240h80v80h160v80H680v80h-80Zm-480-80v-80h400v80H120Z" />
                        </svg>
                    </a>
                    <a href="/notification" className={isActive('/notification')}>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
                            <path
                    ...
                    <div class="avatar" >
                        ...
                        <div class="avatar-option">
                            ...
                            {userData?.user?.roleId?.name === "ADMIN" && (
                                <>
                                    <a href="/admin" class="profile-link">Trang quản lý</a>
                                </>
                            ...
                            {userData?.user?.roleId?.name === "SUPER_ADMIN" && (
                                <>
                                    <a href="/admin" class="profile-link">Trang quản lý</a>
                                    <a href="/supper/admin" class="profile-link">Trang quản lý cấp cao</a>
                                </>
            ...
            <header class="mobile-main-header">
                <div class="mobile-top-header">
                    ...
                    <div class="mobile-searchbar-chat">
                        ...
                        <a href='/message#last-chat' class="mobile-chat-button">
                ...
                <div class="mobile-bottom-header">
                    ...
                    <a href="/follow-post" class="mobile-navbar-link">
                    ...
                    <a href="/list-group" class="mobile-navbar-link">
                    ...
                    <a href="/notification" class="mobile-navbar-link">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M160-200v-80h80v-280q0-83 50-147.5T420-792v-28q0-25 17.5-42.5T480-880q25 0 42.5 17.5T540-820v28q80 20 130 84.5T720-560v280h80v80H160Zm320-300Zm0 420q-33 0-56.5-23.5T400-160h160q0 33-23.5 56.5T480-80ZM320-280h320v-280q0-66-47-113t-113-47q-66 0-113 47t-47 113v280Z" /></svg>
                    </a>
                    <a href="/setting" class="mobile-navbar-link">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M120-200v-80h720v80H120Zm0-160v-80h720v80H120Zm0-160v-80h720v80H120Zm0-160v-80h720v80H120Z" /></svg>
                    </a>
                </div>
            </header>
        </div>
