...
const ListFollowPage = () => {
    ...
    const cancelFriend = async (id) => {
        try {
            ...
            setError('Hủy theo giõi thành công');
            setShowError(true); // Khi có lỗi, hiển thị thông báo
            fetchFriends();
        } catch (error) {
                            ...
                            friends.map(friend => (
                                <div class="friend-item">
                                    ...
                                    <div class="follow-actions">
                                        ...
                                        <a href="#" class="follow-action" onClick={() => cancelFriend(friend?.friend?.userId)}> <i class="fa-solid fa-user-minus"></i>
                                            <p className='follow-action-button-name'>Bỏ theo giõi</p></a>
                                        <a href="#" class="follow-action block-user" onClick={() => blockFriend(friend?.friend?.userId)}><i class="fa-solid fa-ban"></i>  <p className='follow-action-button-name'>Chặn người dùng</p></a>
                                    </div>
                                </div>
                   ))
                ) : (
